# Petal & Tassel - Single-Page Graduation Invitation Website

Website Undangan Wisuda digital yang elegan dengan tema *Petal & Tassel* (kombinasi warna pastel pink, cream, dan mawar). Website ini menggunakan format **Single-Page Application (SPA)** sehingga seluruh konten termuat dalam satu halaman (`index.html`) dengan transisi scroll yang mulus (*smooth scrolling*).
